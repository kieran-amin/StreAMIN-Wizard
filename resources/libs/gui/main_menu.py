...
class MainMenu:
    ...
    def get_listing(self):
        ...
        directory.add_dir('Install Layout Pack', {'mode': 'builds'}, icon=CONFIG.ICONBUILDS, themeit=CONFIG.THEME1)
        ...
        directory.add_dir('Setup Checklist', {'mode': 'checklist'}, icon=CONFIG.ICONSETTINGS, themeit=CONFIG.THEME1)
        directory.add_dir('Post-Install Setup (Popup)', {'mode': 'accounts', 'action': 'menu'}, icon=CONFIG.ICONSETTINGS, themeit=CONFIG.THEME1)
        directory.add_file('Reset Setup Checklist', {'mode': 'accounts', 'action': 'checklist_reset'}, icon=CONFIG.ICONSETTINGS, themeit=CONFIG.THEME1)
        directory.add_separator()
